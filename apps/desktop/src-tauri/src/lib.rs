...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::system::get_releases_page_url,
            ...
            commands::device::profile_device_settings_get,
            commands::device::profile_device_settings_update,
            commands::device::profile_device_settings_regenerate,
            commands::device::profile_device_settings_validate,
            commands::device::profile_device_settings_overview,
            commands::device::device_presets_list,
